...
//	GET_TEST_CMD		= 0x38,
	...
	// Low-level BSD-like sockets functions.
  	SOCKET_SOCKET_CMD       = 0x70,
    SOCKET_CLOSE_CMD        = 0x71,
	SOCKET_ERRNO_CMD        = 0x72,
	SOCKET_BIND_CMD 		= 0x73,
	SOCKET_LISTEN_CMD 		= 0x74,
	SOCKET_ACCEPT_CMD 		= 0x75,
	SOCKET_CONNECT_CMD 		= 0x76,
	SOCKET_SEND_CMD 		= 0x77,
	SOCKET_RECV_CMD 		= 0x78,
	SOCKET_SENDTO_CMD 		= 0x79,
	SOCKET_RECVFROM_CMD 	= 0x7A,
	SOCKET_IOCTL_CMD 		= 0x7B,
	SOCKET_POLL_CMD 		= 0x7C,
	SOCKET_SETSOCKOPT_CMD   = 0x7D,
	SOCKET_GETSOCKOPT_CMD   = 0x7E,
	SOCKET_GETPEERNAME_CMD  = 0x7F,
};
